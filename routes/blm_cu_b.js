...
router.get('/', (req, res) => {
    ...
    res.render('./contents/blm_cu_b',{data:"", data2:"",data3:"",data4:"",pH:"",ChRCR:"",AcRCR:""});
});
...
router.post('/', upload.single('file'), (req,res)=> {
    ...
    var options = {
        ...
        uri: 'http://'+config.app.ip+':'+config.app.port_flask+'/cu3',
        body: name,
    ...
    // sent back from the Flask server 
        .then(function (parsedBody) {
            ...
            if(name['cu_dc_input']!="" && name['cu_dc2_input']!=""){
                ...
                // console.log(lists)
                res.render('./contents/blm_cu_b',{pH:"",ChRCR:"",AcRCR:"",data:lists[0], data2:lists[1], data3:lists[2], data4:lists[3],
            ...
            //eu
                ...
                // console.log(lists)
                res.render('./contents/blm_cu_b',{pH:"",ChRCR:"",AcRCR:"",data:lists[0], data2:lists[1], data3:"", data4:"",
            ...
            //asia
                ...
                res.render('./contents/blm_cu_b',{pH:"",ChRCR:"",AcRCR:"",data:"", data2:"", data3:lists[0], data4:lists[1],
    ...
    .catch(function (err) {
        ...
        var options = {
            ...
            // http:flaskserverurl:port/route
            uri: 'http://'+config.app.ip+':'+config.app.port_flask+'/cu4',
            formData: {
                file: {
        ...
        .then(function (parsedBody) {
            ...
            if(data_s.hasOwnProperty('Chronic RCR') & data_s.hasOwnProperty('Acute RCR')){
                ...
                res.render('./contents/blm_cu_b',{data:"", data2:"", data3:"", data4:"", pH:Object.values(data_s['pH']), Mg:Object.values(data_s['Mg']),
                ...
                res.render('./contents/blm_cu_b',{data:"", data2:"", data3:"", data4:"",AcRCR:"", pH:Object.values(data_s['pH']), Mg:Object.values(data_s['Mg']),
                Ca:Object.values(data_s['Ca']), Na:Object.values(data_s['Na']),DOC:Object.values(data_s['DOC']),
                ...
                res.render('./contents/blm_cu_b',{data:"", data2:"", data3:"", data4:"",ChRCR:"", pH:Object.values(data_s['pH']), Mg:Object.values(data_s['Mg']),
                Ca:Object.values(data_s['Ca']), Na:Object.values(data_s['Na']),DOC:Object.values(data_s['DOC']),
                ...
                res.render('./contents/blm_cu_b',{data:"", data2:"", data3:"", data4:"", ChRCR:"",AcRCR:"",pH:Object.values(data_s['pH']), Mg:Object.values(data_s['Mg']),
                Ca:Object.values(data_s['Ca']), Na:Object.values(data_s['Na']),DOC:Object.values(data_s['DOC']),
