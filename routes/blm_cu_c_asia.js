...
router.get('/', (req, res) => {
    ...
    res.render('./contents/blm_cu_c_asia',{data:"", data2:"", data3:"", data4:"",pH:"",ChRCR:"",AcRCR:""});
});
...
router.post('/', upload.single('file'), (req,res)=> {
    ...
    var options = {
        ...
        uri: 'http://'+config.app.ip+':'+config.app.port_flask+'/cu5_asia',
        body: name,
    ...
    // sent back from the Flask server 
        .then(function (parsedBody) {
            ...
            if(name['cu_dc_input']!="" && name['cu_dc2_input']!=""){
                ...
                // console.log(lists)
                res.render('./contents/blm_cu_c_asia',{pH:"",ChRCR:"",AcRCR:"",data:lists[0], data2:lists[1], data3:lists[2], data4:lists[3],
            ...
            //eu
                ...
                res.render('./contents/blm_cu_c_asia',{pH:"",ChRCR:"",AcRCR:"",data:lists[0], data2:lists[1], data3:"", data4:"",
            ...
            //asia
                ...
                res.render('./contents/blm_cu_c_asia',{pH:"",ChRCR:"",AcRCR:"",data:"", data2:"", data3:lists[0], data4:lists[1],
    ...
    .catch(function (err) {
        ...
        var options = {
            ...
            // http:flaskserverurl:port/route
            uri: 'http://'+config.app.ip+':'+config.app.port_flask+'/cu6_asia',
            formData: {
                file: {
        ...
        .then(function (parsedBody) {
            ...
            if(data_s.hasOwnProperty('Chronic RCR') & data_s.hasOwnProperty('Acute RCR')){
                ...
                res.render('./contents/blm_cu_c_asia',{data:"", data2:"", data3:"", data4:"", pH:Object.values(data_s['pH']),EC:Object.values(data_s['Cond']),DOC:Object.values(data_s['DOC']),
                ...
                res.render('./contents/blm_cu_c_asia',{data:"", data2:"", data3:"", data4:"",AcRCR:"", pH:Object.values(data_s['pH']),EC:Object.values(data_s['Cond']),DOC:Object.values(data_s['DOC'])
                ...
                res.render('./contents/blm_cu_c_asia',{data:"", data2:"", data3:"", data4:"",ChRCR:"", pH:Object.values(data_s['pH']),EC:Object.values(data_s['Cond']),DOC:Object.values(data_s['DOC']),
                ...
                res.render('./contents/blm_cu_c_asia',{data:"", data2:"", data3:"", data4:"", ChRCR:"",AcRCR:"",pH:Object.values(data_s['pH']),EC:Object.values(data_s['Cond']),DOC:Object.values(data_s['DOC']),
...
router.get('/download', (req, res) => {
    const file = `${__dirname}/template_c.csv`;
    // console.log(file);
